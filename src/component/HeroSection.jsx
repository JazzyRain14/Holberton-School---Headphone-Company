...
const HeroSection = () => {
    return (
        <div className='bg-hero-pattern w-full h-[600px] px-[20px] bg-cover bg-no-repeat max-sm:bg-left bg-center flex flex-col justify-end items-center border border-black pb-6'>
