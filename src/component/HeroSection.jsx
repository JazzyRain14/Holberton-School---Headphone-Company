...
const HeroSection = () => {
    return (
        <div className='bg-hero-pattern w-full h-[600px] px-[20px] bg-cover bg-no-repeat max-sm:bg-left bg-center grid place-content-end place-items-center border border-black'>
            <h1 className='font-SourceBold text-2xl leading-8 text-white text-center font-bold'>Lorem ipsum dolor set amet lorem ipsum</h1>
